...
- For completed changes, amend the latest commit without changing its message (`git commit --amend --no-edit`) and force-push `main`; do not create a separate commit.
